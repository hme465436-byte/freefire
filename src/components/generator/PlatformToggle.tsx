  ...
  return (
    <div className="flex gap-6 w-full">
      <button
        ...
        className={cn(
          "flex-1 flex items-center justify-center gap-4 py-6 rounded-xl border-2 transition-all duration-500 group relative overflow-hidden glass-card",
          value === 'android' 
      ...
      >
        ...
        <span className="font-black italic uppercase tracking-[0.2em] text-xl">Android</span>
      ...
      >
        ...
        <span className="font-black italic uppercase tracking-[0.2em] text-xl">Apple iOS</span>
